...
- `PNLF`
  ...
  <Aside type="danger">
  At a first glance it may appear as if it supports AMD laptops, but it is not the same as the one in the [NootedRed](/en/applehax/nootedred) page.
...
- and any backlight-related SSDTs required in the [NootedRed](/en/applehax/nootedred) page.
...
<video width="100%" controls muted autoplay loop preload="auto" width="100%">
  <source src="/en/PatchMerge_ReplaceConfig.mp4" type="video/mp4" />
</video>
