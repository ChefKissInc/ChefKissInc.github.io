...
- `SSE4.2` مطلوب لـ `macOS 10.14`+ وأحدث برامج تشغيل AMD GPU. تجنب `SSE4.1` - وحدات المعالجة المركزية فقط إن أمكن. قد يعمل مع بعض الاختراقات؛ انظر [جمع الملفات > Kexts](/ar/guides/hackintosh/gathering-files/kexts/)
...
- [Raven](https://www.techpowerup.com/gpu-specs/amd-raven.g816) و [Renoir](https://www.techpowerup.com/gpu-specs/amd-renoir.g1058) AMD iGPUs مدعومة عبر [`NootedRed`](/ar/applehax/nootedred/).
