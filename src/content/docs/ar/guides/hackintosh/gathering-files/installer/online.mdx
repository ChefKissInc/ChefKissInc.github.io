...
‫قم بفتح الـTerminal (`cmd` على نظام التشغيل Windows) وقم بتغيير الـDirectory إلى `OpenCorePkg/Utilities/macrecovery`.‬
...
‫انسخ ولصق الأمر في الـTerminal التي فتحتها سابقًا.‬
...
‫بعد انتهاء تشغيل النص البرمجي(Script)، سيكون هناك مجلد جديد يسمى `com.apple.recovery.boot` داخل المجلد الحالي للـTerminal (في هذه الحالة، مجلد `macrecovery`).‬
