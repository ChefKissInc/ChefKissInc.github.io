...
::alert{type="danger"}
:icon{name="IconDanger"} This list is not exhaustive, for more information should check the [`issues on GitHub`](https://github.com/ChefKissInc/NootRX/issues), potentially also the discussions.
::
